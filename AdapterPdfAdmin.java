...
import com.example.smartreaderapp.databinding.RowPdfAdminBinding;
import com.example.smartreaderapp.filters.FilterPdfAdmin;
        ...
        ref.child(categoryId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Log.d(TAG, "loadCategory: onCancelled due to " + error.getMessage());
                    }
                });
    }
